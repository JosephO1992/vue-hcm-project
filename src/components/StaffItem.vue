...
te
			...
			<input
				...
				class="col-3 mx-2 px-3"
			/>
			<button class="btn btn-info col-2 mx-2" @click="showInfo">
				{{ moreInfo ? "Less" : "More" }} Info
			</button>
			<button class="btn btn-info col-2 mx-2" @click="editMode">
				{{ editing ? "Save" : "Edit" }}
			</button>
		</div>
